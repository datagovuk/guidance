...
This page describes the technical detail of DCAT and data.json, as recognized by data.gov.uk. DCAT and data.json are metadata formats suitable for harvesting into data.gov.uk, with more details here: [Harvesting Data into data.gov.uk - DCAT](harvesting.html#dcat)
